...
<main>
    <div class="container">
        <div class="row">
            ...
            <form class="col s6 push-s3" action="addQuestion.php" id="galderenF" name="galderenF" method="post" enctype="multipart/form-data">
                <div class="row">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input type="number" name="zailtasuna" id="zailtasuna" class="validate" min="1" max="5" step="1" required value="3">
